...
import { mockLeaveFormData, mockOrderData } from '../../utils/constants';
...
const LeaveModal = () => {
  ...
  const { setShowLeaveModal, selectedLeaveRecord } = useContext(AppContext);
  ...
  return (
    <Modal>
      <div className="bg-white w-[85%] h-[90vh] rounded-md shadow-md overflow-y-scroll overflow-hidden">
        ...
        {/* body */}
        <LeaveForm isEdit={editMode} mockData={mockLeaveFormData} />
      </div>
    </Modal>
  );
};
