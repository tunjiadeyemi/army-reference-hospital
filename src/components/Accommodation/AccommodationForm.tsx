  ...
  return (
    <div className=" mx-auto  p-8 ">
      <div className="space-y-8 w-full flex-1">
        {/* Army Number Field */}
        <div className="w-full grid grid-cols-1 lg:grid-cols-4 space-x-4">
          <div className="grid grid-cols-1 space-y-2">
            <label className="text-gray-700 font-medium ">ARMY NUMBER</label>
          ...
          {/* Rank Field */}
          <div className="grid grid-cols-1 space-y-2">
            <label className="text-gray-700 font-medium ">RANK</label>
            <div className="lg:col-span-3 relative">
              <button
                type="button"
          ...
          {/* Block No Field */}
          <div className="grid grid-cols-1 space-y-2">
            <label className="text-gray-700 font-medium ">BLOCK NO</label>
            <div className="lg:col-span-3">
              <input
                type="text"
                placeholder="block"
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 space-x-4'>
          <div className="grid grid-cols-1 space-y-2">
            <label className="text-gray-700 font-medium ">ROOM NO.</label>
            <div className="lg:col-span-3">
              <input
                type="text"
                placeholder="Room No"
          ...
          <div className="grid grid-cols-1 space-y-2">
            <label className="text-gray-700 font-medium ">ALLOCATION DATE</label>
            <div className="lg:col-span-3 relative">
              <input
                type="date"
