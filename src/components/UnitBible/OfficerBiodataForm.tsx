...
export const OfficerBioDataForm: React.FC<OfficerBioDataFormProps> = ({
  ...
  const { refetch: refetchOfficers } = useOfficersData();
    ...
    <section className={`${viewMode ? 'mb-20' : ''}`}>
      ...
      <div className="max-w-6xl mx-auto p-6 bg-white">
        ...
        <form onSubmit={handleBiodataSubmit} className="space-y-6">
          {/* Row 1: NAME, P/NO, RANK, CORPS */}

          <div className="grid grid-cols-5 md">
            ...
            <div className="col-span-4 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">NAME</label>
                  <input
                    type="text"
                    placeholder="Full Name"
                    className="w-full px-3 py-2 border max-h-10  border-[#B1B8B7] rounded-md placeholder:text-[13px] outline-none"
                    value={formData.name}
                ...
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">RANK</label>
                  <select
                    className="w-full px-3 py-2 border  border-[#B1B8B7] rounded-md placeholder:text-[13px] outline-none"
                    value={formData.rank}
                ...
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">CORPS</label>
                  <input
                    type="text"
                    placeholder="Corps"
                    className="w-full px-3 py-2 border max-h-10 border-[#B1B8B7] placeholder:text-[13px] rounded-md outline-none"
              ...
              {/* Row 2: QUALIFICATION/TRADE, DATE OF BIRTH, DIRECTORATE, DATE OF COMMISSION */}
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">
                    QUALIFICATION/TRADE
                ...
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">DIRECTORATE</label>
                  <select
                ...
                <div>
                  ...
                  <input
                    type="date"
                    placeholder="DD/MM/YY"
                    className="w-full px-3 py-2 border max-h-10 border-[#B1B8B7] rounded-md outline-none"
              ...
              {/* Row 3: SEX, BLOOD GROUP, GENOTYPE, DATE OF COMMISSION 2 */}
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">SEX</label>
                  <select
                    className="w-full px-3 py-2 border  border-[#B1B8B7] rounded-md outline-none"
                    value={formData.sex}
                ...
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">BLOOD GROUP</label>
                  <select
                    className="w-full px-3 py-2 border  border-[#B1B8B7] rounded-md outline-none"
                ...
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">GENOTYPE</label>
                  <select
                    className="w-full px-3 py-2 border max-h-10 border-[#B1B8B7] placeholder:text-[13px] rounded-md outline-none"
          ...
          {/* Row 4: DATE OF LAST PROMOTION, DATE OF TAKING ON STRENGTH, RELIGION, DATE OF POSTED IN */}
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">RELIGION</label>
              <select
                className="w-full px-3 py-2 border max-h-10 border-[#B1B8B7] placeholder:text-[13px] rounded-md outline-none"
            ...
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">DATE OF POSTED IN</label>
              <input
                type="date"
                placeholder="DD/MM/YY"
                className="w-full px-3 py-2 border max-h-10 border-[#B1B8B7] placeholder:text-[13px] rounded-md outline-none"
            ...
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">MARITAL STATUS</label>
              <select
                className="w-full px-3 py-2 border max-h-10 border-[#B1B8B7] placeholder:text-[13px] rounded-md outline-none"
          ...
          {/* Row 5: MARITAL STATUS, PHONE NUMBER, PLACE OF BIRTH, STATE OF ORIGIN */}
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">PHONE NUMBER</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">PLACE OF BIRTH</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">STATE OF ORIGIN</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">LGA</label>
              <input
                type="text"
                placeholder="LGA"
                className="w-full px-3 py-2 border max-h-10 border-[#B1B8B7] placeholder:text-[13px] rounded-md outline-none"
            ...
            {/* Row 7: PERMANENT HOME ADDRESS, EMAIL ADDRESS */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">EMAIL ADDRESS</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-[13px]   text-gray-700 mb-1">NAME OF NEXT OF KIN</label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border  border-[#B1B8B7] placeholder:text-[13px] rounded-md max-h-10 outline-none  resize-none"
          ...
          {/* Children Names */}
          <div className="grid grid-cols-1 md:grid-cols-8 grid-rows-1 gap-4">
              ...
              <div>
                ...
                <div className="border  border-[#B1B8B7] rounded-md p-3 space-y-2">
                  <input
                    type="text"
                    placeholder="a."
                    className="w-full px-2 py-1 border border-gray-200 placeholder:text-[13px] rounded text-[13px]"
              ...
              <div>
                ...
                <div className="space-y-3">
                    ...
                    <div key={index} className="border  border-[#B1B8B7] rounded-md p-3 space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          type="date"
                          placeholder="Date"
                          className="flex-1 px-2 py-1 border border-gray-200 placeholder:text-[13px] rounded text-[13px]"
                          value={op.date}
                  ...
                  {(!viewMode || editMode) && (
                    ...
                    >
                      <img
                        src="/department/add-black-icon.svg"
                        alt="add icon"
                        className="w-4 h-4"
                      />
                    </button>
            ...
            <div className="grid col-span-2 gap-4">
              <div className="flex flex-col gap-6">
                ...
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">NUMBER OF WIVES</label>
                  <input
                    type="text"
                    placeholder="0"
                    className="w-full px-3 py-2 border max-h-10 border-[#B1B8B7] placeholder:text-[13px] rounded-md outline-none"
                ...
                <div>
                  <label className="block text-[13px]   text-gray-700 mb-1">HONOUR AND AWARD</label>
                  <input
                    placeholder="Honour and Award"
                    className="w-full px-3 py-2 border  border-[#B1B8B7] placeholder:text-[13px] rounded-md outline-none  resize-none"
                ...
                <div className="">
                  <label className="block text-[13px]   text-gray-700 mb-1">REMARKS</label>
                  <input
                    placeholder="Remarks"
                    className="w-full px-3 py-2 border  border-[#B1B8B7]  rounded-md outline-none placeholder:text-[13px]  resize-none"
            ...
            <div className="col-span-3 space-y-4 ">
              <div className="col-span-3">
                <label className="block text-[13px]   text-gray-700 mb-1">NAME OF CHILDREN</label>
                <div className=" border rounded-md border-[#B1B8B7]">
              ...
              <div className="col-span-3">
                <label className="block text-[13px]   text-gray-700 mb-1">NAME OF WIVES</label>
              ...
              <div className="col-span-1">
                <label className="block text-[13px]   text-gray-700 mb-1">SIGNATURE</label>
                <div className="w-full  border  border-[#B1B8B7] rounded-md flex max-h-10 py-3 items-center justify-center text-[#B1B8B7] text-[13px]">
