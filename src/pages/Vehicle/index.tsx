...
import VehicleRecord from '../../components/Vehicle/VehicleRecord';
...
const Vehicle = () => {
  ...
  const tabs = [
    ...
    },
    {
      title: 'Vehicles list',
      slug: 'list',
      icon: activeTab === 'list' ? <VehicleIcon color="white" /> : <VehicleIcon color="gray" />
    }
  ];
  ...
  return (
    <Layout className="h-full">
      <section className="bg-white rounded-md p-6 pb-2">
        <h1 className="text-base font-semibold uppercase">Vehicles Inventory</h1>
      ...
      <section className="bg-white p-4">
        {activeTab === 'add' && <VehicleForm />}
        {activeTab === 'list' && <VehicleRecord />}
      </section>
    </Layout>
  );
};
