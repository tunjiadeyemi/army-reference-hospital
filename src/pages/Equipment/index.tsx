...
const Equipment = () => {
  ...
  const tabs = [
    ...
    {
      title: 'Equipment/Machines list',
      slug: 'list',
      icon: activeTab === 'list' ? <EquipmentIcon color="white" /> : <EquipmentIcon color="gray" />
    }
  ];
  ...
  return (
    <Layout className="h-full">
      <section className="bg-white rounded-md p-6 pb-2">
        <h1 className="text-base font-semibold uppercase">Equipment/Machine Inventory</h1>
      ...
      <section className="bg-white p-4">
        {activeTab === 'add' && <EquipmentForm />}
        {activeTab === 'list' && <EquipmentRecord />}
      </section>
    </Layout>
  );
};
