...
import StaffRecord from '../../components/Staff/StaffRecord';
...
const Staff = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      slug: 'list',
      icon: activeTab === 'list' ? <StaffIcon color="white" /> : <StaffIcon color="gray" />
    }
  ];
  ...
  return (
    <Layout className="h-full">
      <section className="bg-white rounded-md p-6 pb-2">
        <h1 className="text-base font-semibold uppercase">Staff Nominal Roll</h1>
      ...
      <section className="bg-white p-4">
        {activeTab === 'add' && <StaffForm />}
        {activeTab === 'list' && <StaffRecord />}
      </section>
    </Layout>
  );
};
