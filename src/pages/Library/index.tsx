...
import LibraryRecord from '../../components/Library/LibraryRecord';
...
const Library = () => {
  ...
  const tabs = [
    ...
    },
    {
      title: 'NA Book list',
      slug: 'list',
      icon: activeTab === 'list' ? <LibraryIcon color="white" /> : <LibraryIcon color="gray" />
    }
  ];
  ...
  return (
    <Layout className="h-full">
      <section className="bg-white rounded-md p-6 pb-2">
        <h1 className="text-base font-semibold uppercase">Library /NA Books</h1>
      ...
      <section className="bg-white p-4">
        {activeTab === 'add' && <LibraryForm />}
        {activeTab === 'list' && <LibraryRecord />}
      </section>
    </Layout>
  );
};
