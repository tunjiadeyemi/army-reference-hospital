...
import SignalRecord from '../../components/Signal/SignalRecord';
...
const Signal = () => {
  ...
  const tabs = [
    ...
    },
    {
      title: 'Signal list',
      slug: 'list',
      icon: activeTab === 'list' ? <SignalIcon color="white" /> : <SignalIcon color="gray" />
    }
  ];
  ...
  return (
    <Layout className="h-full">
      <section className="bg-white rounded-md p-6 pb-2">
        <h1 className="text-base font-semibold uppercase">Signal Form/NA Form</h1>
      ...
      <section className="bg-white p-4">
        {activeTab === 'add' && <SignalForm />}
        {activeTab === 'list' && <SignalRecord />}
      </section>
    </Layout>
  );
};
