...
import MammyRecord from '../../components/Mammy/MammyRecord';
import MammyForm from '../../components/Mammy/MammyForm';
...
const Mammy = () => {
  ...
  const tabs = [
    ...
    {
      title: 'Allocated Shops list',
      slug: 'list',
      icon: activeTab === 'list' ? <MammyIcon color="white" /> : <MammyIcon color="gray" />
    }
  ];
  ...
  return (
    <Layout className="h-full">
      <section className="bg-white rounded-md p-6 pb-2">
        <h1 className="text-base font-semibold uppercase">Mammy Market</h1>
      ...
      <section className="bg-white p-4">
        {activeTab === 'add' && <MammyForm />}
        {activeTab === 'list' && <MammyRecord />}
      </section>
    </Layout>
  );
};

export default Mammy;
