...
import AccommodationRecord from '../../components/Accommodation/AccommodationRecord';
...
const Accommodation = () => {
  ...
  const tabs = [
    ...
    {
      title: 'Accommodations Return list',
      slug: 'list',
      icon:
        activeTab === 'list' ? (
          <AccommodationIcon color="white" />
        ) : (
          <AccommodationIcon color="gray" />
        )
    }
  ];
  ...
  return (
    <Layout className="h-full">
      <section className="bg-white rounded-md p-6 pb-2">
        <h1 className="text-base font-semibold uppercase">Accommodation Returns</h1>
      ...
      <section className="bg-white p-4">
        {activeTab === 'add' && <AccommodationForm />}
        {activeTab === 'list' && <AccommodationRecord />}
      </section>
    </Layout>
  );
};
